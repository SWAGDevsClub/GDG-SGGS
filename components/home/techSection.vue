    ...
    <v-row>
      <v-col md="9" sm="7" cols="12">
        <div
          ...
          class="pa-8"
        >
          <h1>Stay updated on the Google Technologies</h1>
          <p>
             We are focusing on the technologies that are trending in the market and are in demand. Let's come together and learn about these technologies from industry leading experts.
          </p>
          <v-container fluid>
